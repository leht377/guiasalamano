                ...
                <div class="modal-content" id="modal-info-guia">
                    ...
                    <div class="modal-footer bg-violet-dark d-flex justify-content-start border-0">
                        <button class="fw-bold px-3 py-2 border-0 rounded"
                            style="background-color:#FAD318;">Solicitar</button>
        ...
        <main class="row" style="min-height:90%" ;>
            <aside class="col-xl-2 col-sm-12 p-0 bg-violet-light sticky-top">
                <div class="d-xl-none w-100 px-4 py-3 d-flex align-items-center">
                    <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                        data-bs-target="#menuOpciones" aria-expanded="false" aria-controls="menuOpciones">
                ...
                <div class="d-xl-block" id="menuOpciones">
                    ...
                    <div class="container">
                        ...
                        <ul class="s p-0" id="lista-destinos">
                            <li class="list-unstyled p-2 text-white rounded fw-bold active-menu-opcion opciones-menu"
                                role="button">La
                                Bocana</li>
                    ...
                    <div class="container">
                        ...
                        <ul class="p-0" id="lista-destinos">
                            <li class="list-unstyled p-2 text-white rounded fw-bold opciones-menu" role="button"><i
            ...
            <section class="col-xl-10 col-sm-12 p-3 bg-violet-light">
                <div class="informacion_dash w-100">
                    <h4 class="mb-3 p-2 text-white fw-bold">Guias postulados la bocana</h4>
                </div>
