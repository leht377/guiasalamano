...
<head>
  ...
  <link rel="stylesheet" href="static/css/estilosform.css">
...
<body id="container-registro-guia">
  <main class="d-flex align-items-center vh-100">
    <form class="p-4 needs-validation container-xl container-sm  " novalidate  method="post" id="box-card-guia"> 
      ...
      <div class="row">
        ...
        <div class="col-xl-6  col-md-6 col-sm-12">
          <div class="form-floating">
            <select class="form-select bg-transparent text-white  mb-3" id="floatingSelect" aria-label="Floating label select example">
        ...
        <div class="col-6">
          <div class="form-floating">
            <select class="form-select bg-transparent text-white" id="floatingSelect" aria-label="Floating label select example">
              <option selected>Seleccionar...</option>
