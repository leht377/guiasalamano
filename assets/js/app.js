  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      resultado.forEach((resultado) => {
        console.log(resultado);
        template = ` 
          <form action='index.php?c=clienteDashboard&a=updatePhotoCliente' method="post" class="d-flex align-items-center p-2 flex-column"  enctype="multipart/form-data" style="width: 260px; height: 320px; background-color: #311178; border-radius:10px;">
